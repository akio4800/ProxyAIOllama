package at.s2g.ai.settings.prompts.form.details

import at.s2g.ai.settings.prompts.CommitMessageTemplate
import at.s2g.ai.settings.prompts.CoreActionsState.Companion.DEFAULT_EDIT_CODE_PROMPT
import at.s2g.ai.settings.prompts.CoreActionsState.Companion.DEFAULT_FIX_COMPILE_ERRORS_PROMPT
import at.s2g.ai.settings.prompts.CoreActionsState.Companion.DEFAULT_GENERATE_COMMIT_MESSAGE_PROMPT
import at.s2g.ai.settings.prompts.CoreActionsState.Companion.DEFAULT_GENERATE_NAME_LOOKUPS_PROMPT
import at.s2g.ai.settings.prompts.CoreActionsState.Companion.DEFAULT_REVIEW_CHANGES_PROMPT
