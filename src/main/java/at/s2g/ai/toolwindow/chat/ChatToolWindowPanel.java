...
import at.s2g.ai.actions.toolwindow.ClearChatWindowAction;
import at.s2g.ai.actions.toolwindow.CreateNewConversationAction;
import at.s2g.ai.actions.toolwindow.OpenInEditorAction;
...
import at.s2g.ai.settings.prompts.PersonaPromptDetailsState;
import at.s2g.ai.settings.prompts.PromptsConfigurable;
...
import at.s2g.ai.toolwindow.chat.ui.ToolWindowFooterNotification;
import at.s2g.ai.toolwindow.chat.ui.textarea.AttachImageNotifier;
