package at.s2g.ai.toolwindow.chat.editor;
...
import at.s2g.ai.actions.toolwindow.ReplaceCodeInMainEditorAction;
import at.s2g.ai.toolwindow.chat.editor.actions.AutoApplyAction;
import at.s2g.ai.toolwindow.chat.editor.actions.CopyAction;
import at.s2g.ai.toolwindow.chat.editor.actions.DiffAction;
import at.s2g.ai.toolwindow.chat.editor.actions.EditAction;
import at.s2g.ai.toolwindow.chat.editor.actions.InsertAtCaretAction;
import at.s2g.ai.toolwindow.chat.editor.actions.NewFileAction;
import at.s2g.ai.toolwindow.chat.editor.actions.ReplaceSelectionAction;
import at.s2g.ai.util.EditorUtil;

import static at.s2g.ai.util.file.FileUtil.findLanguageExtensionMapping;
