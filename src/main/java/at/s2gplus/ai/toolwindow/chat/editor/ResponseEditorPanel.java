package at.s2gplus.ai.toolwindow.chat.editor;
...
import at.s2gplus.ai.actions.toolwindow.ReplaceCodeInMainEditorAction;
import at.s2gplus.ai.toolwindow.chat.editor.actions.AutoApplyAction;
import at.s2gplus.ai.toolwindow.chat.editor.actions.CopyAction;
import at.s2gplus.ai.toolwindow.chat.editor.actions.DiffAction;
import at.s2gplus.ai.toolwindow.chat.editor.actions.EditAction;
import at.s2gplus.ai.toolwindow.chat.editor.actions.InsertAtCaretAction;
import at.s2gplus.ai.toolwindow.chat.editor.actions.NewFileAction;
import at.s2gplus.ai.toolwindow.chat.editor.actions.ReplaceSelectionAction;
import at.s2gplus.ai.util.EditorUtil;

import static at.s2gplus.ai.util.file.FileUtil.findLanguageExtensionMapping;
