package at.s2gplus.ai.toolwindow.chat.ui;
...
import at.s2gplus.ai.settings.GeneralSettingsConfigurable;
import at.s2gplus.ai.settings.service.ServiceType;
import at.s2gplus.ai.toolwindow.chat.StreamParser;
import at.s2gplus.ai.toolwindow.chat.ThinkingOutputParser;
import at.s2gplus.ai.toolwindow.chat.editor.ResponseEditorPanel;
import at.s2gplus.ai.toolwindow.chat.editor.actions.CopyAction;
import at.s2gplus.ai.toolwindow.ui.ResponseBodyProgressPanel;
import at.s2gplus.ai.toolwindow.ui.WebpageList;
import at.s2gplus.ai.ui.ThoughtProcessPanel;
import at.s2gplus.ai.ui.UIUtil;
import at.s2gplus.ai.util.EditorUtil;
import at.s2gplus.ai.util.MarkdownUtil;

import static at.s2gplus.ai.toolwindow.chat.StreamResponseType.CODE;
import static at.s2gplus.ai.util.MarkdownUtil.convertMdToHtml;
